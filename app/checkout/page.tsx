  ...
  return <main className="siteShell"><SiteHeader/>
    <section className="contentWidth checkoutWrap">
      <div className="checkoutMain">
        ...
        <div className="checkoutSection"><div className="checkoutSectionHeading"><h2>How to place a test order</h2><span>1</span></div><div className="featureList"><div className="featureListItem"><span className="checkIcon">1</span><span>Create or sign in to your customer account.</span></div><div className="featureListItem"><span className="checkIcon">2</span><span>Choose a package and customized meals/day and days/week version.</span></div><div className="featureListItem"><span className="checkIcon">3</span><span>Select every required meal for the full monthly schedule.</span></div><div className="featureListItem"><span className="checkIcon">4</span><span>Save the schedule. The version price is stored on the order and selections are locked.</span></div></div></div>
